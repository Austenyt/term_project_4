from items import print_prettytable_hhru
from items import print_prettytable_sj


def print_welcome_user_1():
    print("\n---Добро пожаловать в парсер вакансий!---\n"
          "Программа получает информацию о вакансиях с разных платформ."
          "\nСохраняет полученную информацию в файл и позволяет удобно работать с ней (добавлять, фильтровать, удалять).")
...
def print_operations():
    print("1. Ввести поисковый запрос;"
          ...
          "\n3. Получить вакансии в выбранном регионе;"
